...
/*  99 */     this.comma = false;
/* 100 */     this.mode = 'i';
/* 101 */     this.stack = new JSONObject[200];
/* 102 */     this.top = 0;
/* 103 */     this.writer = w;
/*     */   }
/*     */ 
...
/*     */ 
/*     */       
/* 283 */       .mode = (this.top == 0) ? 'd' : ((this.stack[this.top - 1] == null) ? 'a' : 'k');
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */       } 
/*     */     } 
/* 355 */     if (value instanceof Boolean || value instanceof JSONObject || value instanceof JSONArray)
/*     */     {
...
/* Location:              O:\OneDrive\_Games\Minecraft\Jualmi Server\ReadSignsAndBooks.jar!\org\json\JSONWriter.class
