...
* *Ready-to-use Minecraft Datapacks* (4 versions, each in its own folder):
...
*** `data/readbooks/function/books.mcfunction` - Commands to recreate all books
*** `data/readbooks/function/signs.mcfunction` - Commands to recreate all signs
