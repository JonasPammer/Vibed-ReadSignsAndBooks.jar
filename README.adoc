...
The Windows version includes a bundled Java runtime - no Java installation needed!
...
* *Nether portal detection:* Find all portals with intelligent clustering (dimensions, center coordinates)
* *Block search:* Search for any block type across dimensions
...
* `--find-portals` - Detect portal structures with center coordinates
